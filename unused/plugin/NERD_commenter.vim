...
vnoremap <silent> <plug>NERDCommenterComment <ESC>:call NERDComment(0, "norm")<cr>
...
if g:NERDCreateDefaultMappings
	call s:CreateMaps('<pug>NERDCommenterComment',    ',cc')
	...
	call s:CreateMaps('<plug>NERDCommenterInvert',     '<c-c>')
